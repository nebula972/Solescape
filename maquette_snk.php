    ...
    <section>
        ...
        <?php 
            ...
            echo '<label for="size">Sélectionnez votre pointure :</label>';
                ...
                echo '<option value="35">35 EU</option>';
                echo '<option value="36">36 EU</option>';
                echo '<option value="37">37 EU</option>';
                echo '<option value="38">38 EU</option>';
                echo '<option value="39">39 EU</option>';
                echo '<option value="40">40 EU</option>';
                echo '<option value="41">41 EU</option>';
                echo '<option value="42">42 EU</option>';
                echo '<option value="43">43 EU</option>';
                echo '<option value="44">44 EU</option>';
                echo '<option value="45">45 EU</option>';
                echo '<option value="46">46 EU</option>';
                echo '<option value="47">47 EU</option>';
                echo 'option value="48">48 EU</option>';
                echo 'option value="49">48 EU</option>';
                echo 'option value="50">48 EU</option>';
                echo '</select>';
